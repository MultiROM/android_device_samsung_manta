...
#JB ARCH_ARM_HAVE_TLS_REGISTER := true
#JB TARGET_GCC_VERSION := 4.7
#JB TARGET_USE_O3 := true
#JB 
#JB # Enable various prefetch optimizations
#JB COMMON_GLOBAL_CFLAGS += -D__ARM_USE_PLD -D__ARM_CACHE_LINE_SIZE=64
